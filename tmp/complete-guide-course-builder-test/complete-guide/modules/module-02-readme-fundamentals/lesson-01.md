# Lesson 01: เขียน README ให้คนอ่านเข้าใจ project ได้ทันที

## Lesson Goal

เมื่อจบบทนี้ นักเรียนจะเข้าใจว่า README ที่ดีต้องเริ่มจาก problem, purpose และ next step ไม่ใช่แค่ข้อความสั้น ๆ

## Start from branch

Start from branch: module-02-lesson-01-start
...
Your code should now match branch: module-02-lesson-01-finished
