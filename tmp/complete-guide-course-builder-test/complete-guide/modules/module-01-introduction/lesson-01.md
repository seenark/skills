# Lesson 01: เข้าใจ repository และ README จากปัญหาจริง

## Lesson Goal

เมื่อจบบทนี้ นักเรียนจะเข้าใจว่า repository เล็ก ๆ ยังสอน workflow และ project communication ได้

## Start from branch

Start from branch: module-01-lesson-01-start
...
Your code should now match branch: module-01-lesson-01-finished
